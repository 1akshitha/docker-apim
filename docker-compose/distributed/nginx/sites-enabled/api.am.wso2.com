...
server {
    ...
    location /services {
               ...
               proxy_read_timeout 5m;
               proxy_send_timeout 5m;
               proxy_pass https://sslapi.am.wso2.com/services;
        }
    location /publisher {
               proxy_set_header X-Forwarded-Host $host;
               proxy_set_header X-Forwarded-Server $host;
    ...
    location /admin {
       ...
       location /api/am/admin/v2{
               ...
               proxy_read_timeout 5m;
               proxy_send_timeout 5m;
               proxy_pass https://sslapi.am.wso2.com/api/am/admin/v2;
       }
       location /api/am/publisher/v2{
               ...
               proxy_read_timeout 5m;
               proxy_send_timeout 5m;
               proxy_pass https://sslapi.am.wso2.com/api/am/publisher/v2;
       }
